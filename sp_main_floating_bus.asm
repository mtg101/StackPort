; sp_main -- floating bus and racing beam version: sp_main_floating_bus.asm
; 120 scanlines to draw before main screen starts
; need 192 for 16col vert... (use sp_main_timing_chasing.asm for that)
;
; can use for blitting lower half of screen
; extra 92 scanlines = 216 scanlines, enough time for 92*2 stack blits
...
INITIAL_SETUP_TRIGGER_ATTR_LOOP:	
	LD		(HL), A 
	INC  	HL
	DJNZ 	INITIAL_SETUP_TRIGGER_ATTR_LOOP
